...
class VistaGasto:
    def __init__(self, root):
        ...
        self.label_descripcion = tk.Label(self.root, text="Descripción del Gasto")
        ...
        self.categoria_combobox = ttk.Combobox(self.root, values=self.categorias_nombres)
        self.categoria_combobox.pack()

        # Monto del Gasto
        self.label_monto = tk.Label(self.root, text="Monto del Gasto")
        self.label_monto.pack()
        self.monto_entry = tk.Entry(self.root)
        ...
        # Método de pago
        self.label_metodo_pago = tk.Label(self.root, text="Método de Pago")
        self.label_metodo_pago.pack()
        self.metodo_pago_entry = tk.Entry(self.root)
        self.metodo_pago_entry.pack()

        # Proveedor
        self.label_proveedor = tk.Label(self.root, text="Proveedor")
        self.label_proveedor.pack()
        self.proveedor_entry = tk.Entry(self.root)
        self.proveedor_entry.pack()

        # Notas
        self.label_notas = tk.Label(self.root, text="Notas")
        self.label_notas.pack()
        self.notas_entry = tk.Entry(self.root)
        self.notas_entry.pack()

        # Botones
        self.agregar_btn = tk.Button(self.root, text="Agregar Gasto", command=self.agregar_gasto)
        self.agregar_btn.pack()

        self.listar_btn = tk.Button(self.root, text="Listar Gastos", command=self.listar_gastos)
        self.listar_btn.pack()

        self.eliminar_btn = tk.Button(self.root, text="Eliminar Gasto", command=self.eliminar_gasto)
        self.eliminar_btn.pack()

        # Listbox para mostrar los gastos
        self.gastos_listbox = tk.Listbox(self.root, width=50, height=10)
