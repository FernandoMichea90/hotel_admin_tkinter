...
class ReservaView:
    ...
    def mostrar_reservas(self):
        ...
        values = [
            ...
            {'nombre': "Fernando", 'apellido': "Gonzalez", 'habitacion': "101", 'codigo': "A101", 'precio': 120, 'check_in': date(2024, 12, 5), 'check_out': date(2024, 12, 10)},
            {'nombre': "Maria", 'apellido': "Lopez", 'habitacion': "102", 'codigo': "A102", 'precio': 150, 'check_in': date(2024, 12, 7), 'check_out': date(2024, 12, 12)},
        ...
        self.scrollable_card_frame = MyScrollableCardFrame(self.frame, title="Reservas", values=values)
